  ...
  return (
    <aside className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
      ...
      <ul className="sidebar-menu">
        ...
        <li><NavLink to="/schedules" className={nav => (nav.isActive ? "active" : "")}><i className="fas fa-clipboard-list"></i> {!isCollapsed && 'Schedule'}</NavLink></li>
        <li><NavLink to="/calendar" className={nav => (nav.isActive ? "active" : "")}><i className="fas fa-clipboard-list"></i> {!isCollapsed && 'View Calendar'}</NavLink></li>
